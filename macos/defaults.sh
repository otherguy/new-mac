...
sudo scutil --set HostName "${${${COMPUTER_NAME:l}//\'/}// /-}"
sudo scutil --set LocalHostName "${${${COMPUTER_NAME:l}//\'/}// /-}"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "${${${COMPUTER_NAME:l}//\'/}// /-}"

# Disable audio feedback when volume is changed
defaults write com.apple.sound.beep.feedback -bool false

# This plays the startup chime at a substantially reduced volume level
...
#sudo defaults write /Library/Preferences/com.apple.loginwindow LoginwindowText 'This \uf8ff belongs to Alexander Graf (alex@basecamp.tirol)'
...
# Finder: disable quitting via ⌘ + Q; doing so will also hide desktop icons
